...
class Simulation(object):
    ...
    """
    def __init__(self, ini_cndtn=None, method='RK45', user_name=None):
        """
        Parameters
        ----------
        ini_cndtn : list
...
class HarmonicOsc1D(Simulation):
    ...
    """
    def __init__(self, ini_cndtn=[0., 1.], m=1.,
                 k=1., method='RK45', user_name=None):
        """Extends __init__ from Simulation
        
        Adds attributes `k` and `m` to bunch of Simulation's attributes.
        ...
        """
        super().__init__(ini_cndtn=ini_cndtn, method=method, user_name=user_name)
        self.m = m
        self.k = k
