...
class Simulation(object):
    ...
    ini_cndtn : list or None, optional
        ...
        the system being simulated. Default is None.
    results : OdeResult
        Results of simulation. Default is None.
    system : string or None, optional
        Description of simulated system. Default is None.
    method : str, optional
        Method of integration, varies depending on simulation. See
        avaliable integration methods on `scipy.integrate.solve_ivp`
        documentation. Default is 'RK45'.
